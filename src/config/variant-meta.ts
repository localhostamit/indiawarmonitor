...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  india: {
    title: 'Bharat Monitor - India Geopolitics, Markets & War Impact',
    description: 'India-focused intelligence dashboard tracking Indian leaders, war impact on India, oil & gold prices, Sensex/Nifty markets, Indian foreign policy, defence, and live news.',
    keywords: 'India monitor, Bharat monitor, India geopolitics, Indian leaders tweets, war impact India, India oil prices, gold price India, Sensex Nifty, India China border, India Pakistan, Modi foreign policy, Indian defence, India economy, NDTV live, India today live',
    url: 'https://india.worldmonitor.app/',
    siteName: 'Bharat Monitor',
    shortName: 'BharatMonitor',
    subject: 'India Geopolitics, War Impact, and Economic Intelligence',
    classification: 'India Intelligence Dashboard, Geopolitical Monitor, India News',
    categories: ['news', 'geopolitics'],
    features: [
      'India live news (NDTV, India Today, WION)',
      'Indian leader statements tracking',
      'War impact on India analysis',
      'India oil & gold price tracking',
      'Sensex/Nifty market data',
      'India-China border monitoring',
      'India-Pakistan tension tracker',
      'India foreign policy & diplomacy',
      'Indian defence news',
      'India economic indicators',
      'Live cameras & webcams',
    ],
  },
};